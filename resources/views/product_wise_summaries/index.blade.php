        ...
        <div class="row">
            ...
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <form id="filter-form">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="fuel_grade_id">Fuel Grade ID</label>
                                        <input type="text" class="form-control" id="fuel_grade_id" name="fuel_grade_id" placeholder="Search Fuel Grade">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card custom-card">
                    <div class="card-header custom-card-header">
                        <h4 class="mb-0">Product Wise Summaries</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="product-wise-summaries-table" class="table-bordered table">
...
@push('js')
    <script>
        $(document).ready(function() {
            var table = $('#product-wise-summaries-table').DataTable({
                'processing': true,
                'serverSide': true,
                'ajax': {
                    'url': '{{ route('product_wise_summaries') }}',
                    'data': function(d) {
                        ...
                        d.fuel_grade_id = $('#fuel_grade_id').val();
                    }
                },
                'order': [0, 'desc'],
                'columns': [{
            ...
            $('#export-excel-btn').on('click', function() {
                ...
                window.location.href = '{{ route('product_wise_summaries.export.excel') }}?' + queryString;
            });
            ...
            $('#export-pdf-btn').on('click', function() {
                ...
                const queryString = $.param(filters);
                window.location.href = '{{ route('product_wise_summaries.export.pdf') }}?' + queryString;
            });
