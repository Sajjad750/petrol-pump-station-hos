<aside class="main-sidebar sidebar-light-primary elevation-4">
    <!-- Brand Logo -->
    <a href="" class="brand-link"style="padding:2.8rem 1.5rem;">
        <span class="brand-text font-weight-light"> <img src="{{ asset('assets/img/logo/site-logo1.png') }}" width=80%" alt="Logo"></span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
