...
$(document).ready(function() {
    ...
    var sites = [
        {name: "Downtown Station", lat: 40.7589, lng: -73.9851, status: "online"},
        {name: "Highway Station", lat: 40.6892, lng: -74.0445, status: "warning"},
        {name: "Airport Station", lat: 40.6413, lng: -73.7781, status: "online"},
        {name: "Mall Station", lat: 40.7505, lng: -73.9934, status: "offline"},
        {name: "Suburb Station", lat: 40.6782, lng: -73.9442, status: "online"}
    ];
